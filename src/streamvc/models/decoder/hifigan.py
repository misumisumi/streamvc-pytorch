...
class HiFiGANGenerator(nn.Module):
    ...
    def __init__(
        ...
        channels: int = 512,
        kernel_size: int = 7,
        upsample_scales: tuple = (5, 4, 3, 2),
        upsample_kernel_sizes: tuple = (10, 8, 6, 4),
        qp_resblock_kernel_size: int = 3,
        qp_resblock_dilations: list = [(1), (1, 2), (1, 2, 4), (1, 2, 4, 8)],
        qp_use_additional_convs: bool = True,
        resblock_kernel_sizes: tuple = (3, 7, 11),
        resblock_dilations: list = [(1, 3, 5), (1, 3, 5), (1, 3, 5)],
        use_additional_convs: bool = False,
        use_sine_embs: bool = False,
        use_qp_resblocks: bool = False,
        bias: bool = True,
        nonlinear_activation: str = "LeakyReLU",
        nonlinear_activation_params: dict = {"negative_slope": 0.1},
    ...
    def forward(self, c, x=None, d=None, s=None):

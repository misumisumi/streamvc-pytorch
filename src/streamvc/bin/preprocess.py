...
from streamvc.modules.yin import YinExtractor
...
_yin_extractor: Optional[YinExtractor] = None
...
def _init_worker(config_dict: dict):
    ...
    """
    global _hubert_model, _spk_extractor, _yin_extractor, _config
    ...
    _yin_extractor = YinExtractor(**_config.yin)
    _yin_extractor = _yin_extractor.to(_config.device)
...
def _process_file_worker(filepath: str):
    ...
    assert _yin_extractor is not None, "YIN extractor not initialized in worker"
